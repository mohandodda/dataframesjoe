...
# MAGIC %md # GroupBy and Aggregate Functions
# MAGIC 
...
# MAGIC %md Read in the customer sales data
...
# MAGIC %md Let's group together by company!
...
# MAGIC %md This returns a GroupedData object, off of which you can all various methods
...
# MAGIC %md Check out this link for more info on other methods:
...
# MAGIC %md Often you will want to change the name, use the .alias() method for this:
...
# MAGIC %md That is a lot of precision for digits! Let's use the format_number to fix that!
...
# MAGIC %md Most basic functions you would expect to be available are, so make sure to check out the documentation!
